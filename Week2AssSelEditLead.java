...
public class Week2AssSelEditLead {
	public static void main(String[] args) {
		...
		WebDriverManager.chromedriver().setup(); 
		 ...
		 impNoteElement.sendKeys("Sample information");
		 
		 WebElement updateLeadElement = driver.findElement(By.name("submitButton"));
		 updateLeadElement.click();
